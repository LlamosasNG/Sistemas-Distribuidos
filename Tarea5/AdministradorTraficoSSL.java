/*
  ...
  Generado por ChatGPT modificado por LlamosasNG
*/
...
class AdministradorTraficoSSL {
    ...
    public void run() {
      try {
        ...
        while ((n = entrada_1.read(buffer)) != -1) {
          ...
          // Reenvía los datos del cliente al segundo servidor remoto (sin esperar la
          // respuesta)
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.println("Conectando a " + host_remoto_1 + ":" + puerto_remoto_1 + " y " + host_remoto_2 + ":"
        + puerto_remoto_2 + " en puerto local " + puerto_local);
